...
var opProto = "http://ui2.";
var opLiveURL = opProto + 'ehow.co.uk/ui/shared/scripts/external/optimost/live.js';
var opQaURL = opProto + 'ehow.co.uk/ui/shared/scripts/external/optimost/staging.js';
var opContentURL = opLiveURL;
var opThisURL = document.location.toString();
opThisURL = opThisURL.split('?')[0];
if (opThisURL) {
	if (typeof(optimost)=='object') {
		if (optimost.Q['opqa'] && optimost.Q['opqa']=='opqa') opContentURL = opQaURL;
	}
}
document.write('<' + 'script src="' + opContentURL + '"></' + 'script>\n');
